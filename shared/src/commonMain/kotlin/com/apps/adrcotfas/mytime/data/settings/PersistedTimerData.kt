 ...
 */
package com.apps.adrcotfas.mytime.data.settings

import com.apps.adrcotfas.mytime.bl.TimerRuntimeState
...
data class PersistedTimerState(
    ...
    fun toRuntimeState() = TimerRuntimeState(
        ...
        state = com.apps.adrcotfas.mytime.bl.TimerState.entries[state],
        type = com.apps.adrcotfas.mytime.bl.TimerType.entries[type],
