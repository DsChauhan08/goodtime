 ...
 */
package com.apps.adrcotfas.mytime.appkilltest
...
class KillRecoveryTest {
    private val driver = MyTimeDriver()

    @Before
    fun freshStart() {
        // wipe data; each test then seeds and launches (some need auto-start enabled)
        driver.shell("pm clear ${MyTimeDriver.PACKAGE}")
        ...
        driver.shell("pm grant ${MyTimeDriver.PACKAGE} android.permission.POST_NOTIFICATIONS")
    }
